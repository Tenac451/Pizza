...
public class MenuVO {
	 ...
	 */
	public MenuVO() {
		dishes = new ArrayList<DishVO>();
		initMenu();
	}

	public MenuVO(ArrayList<DishVO> readedDishes) {
		//System.out.println(readedDishes);
		dishes = readedDishes;
	}
	...
	/**
	 * Returns the object in human-readable form. Calls for getter of the individual
	 * courts. Is based on the initialization sequence: pizza, pasta, dessert
	 * 
	...
	public String toString() {
		...
		do {
			if (dishes.get(i) != null) {
				...
				if (i < dishes.size() && dishes.get(i).getNumber() == dishes.get(i + 1).getNumber()) {
