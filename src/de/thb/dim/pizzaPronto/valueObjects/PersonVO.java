 ...
 * 
 * @author Gabrile Schmidt * @version 1.0
 * @since 27.05.2018
 *
 */
...
abstract class PersonVO implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (this.getClass() == obj.getClass()) {
			...
			isEqual = (other.getFirstName().equals(firstName) && other.getLastName().equals(lastName)
					&& other.getStreet().equals(street) && other.getHouseNumber() == houseNumber);
		}
